...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_post', (
            ...
            ('authored_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
    ...
    models = {
        ...
        'blog.post': {
            'Meta': {'ordering': "('-authored_at',)", 'object_name': 'Post'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'authored_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
